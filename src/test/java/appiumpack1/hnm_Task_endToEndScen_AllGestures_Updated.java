...
public class hnm_Task_endToEndScen_AllGestures_Updated {
...
//		ele.click();
	...
	@Test
	public void doubleGesturehnm() throws MalformedURLException, InterruptedException {

		driver.findElement(AppiumBy.androidUIAutomator(
				"new UiScrollable(new UiSelector()).scrollIntoView(text(\"Black and white tailoring\"));"));
		Thread.sleep(5000);
		driver.findElement(AppiumBy.xpath(
				"//android.widget.TextView[@resource-id=\"com.hm.goe:id/text_headline\" and @text=\"Black and white tailoring\"]"))
				.click();
	...
	public void swipeGesture() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(AppiumBy.androidUIAutomator(
				"new UiScrollable(new UiSelector()).scrollIntoView(text(\"From dresses and shirts to cosy knits and pretty plaids.\"));"));

//		driver.findElement(AppiumBy
//				.xpath("//android.widget.TextView[@resource-id=\"com.hm.goe:id/simple_row_text\" and @text=\"Kids\"]"))
//				.click();

		driver.findElement(AppiumBy.id("com.hm.goe:id/text_preamble_bottom")).click();
		Thread.sleep(2000);
		driver.findElement(AppiumBy.xpath("(//android.widget.ImageView[@resource-id=\"com.hm.goe:id/image\"])[2]"))
				.click();
		Thread.sleep(1000);
	...
	public void pinchGesture() throws InterruptedException {
		 ...
		 * 
		 * driver.findElement(AppiumBy.xpath(
		 * "(//android.widget.TextView[@resource-id=\"com.hm.goe:id/productName\"])[2]")
		 * ) .click();
		 * 
		 * driver.findElement(AppiumBy.id("com.hm.goe:id/carouselImage")).click();
		 * WebElement element =
		 * driver.findElement(AppiumBy.id("com.hm.goe:id/carouselPhotoView"));
		 */
...
//					.click();
		...
		driver.findElement(AppiumBy.id("com.hm.goe:id/text_preamble_bottom")).click();
		Thread.sleep(2000);
		driver.findElement(AppiumBy.xpath("(//android.widget.ImageView[@resource-id=\"com.hm.goe:id/image\"])[1]"))
				.click();
		Thread.sleep(1000);
		driver.findElement(AppiumBy.id("com.hm.goe:id/carouselImage")).click();
	...
	public void dragGesture() throws InterruptedException {
		...
		driver.findElement(AppiumBy.xpath(
				"(//android.widget.RelativeLayout[@resource-id=\"com.hm.goe:id/teaser_area_child_container\"])[1]"))
				.click();
		...
		Thread.sleep(4000);
		((JavascriptExecutor) driver).executeScript("mobile:clickGesture", ImmutableMap.of("x", 538, "y", 2137));

		driver.findElement(AppiumBy.xpath(
				"//android.view.ViewGroup[@resource-id=\"com.hm.goe:id/hm_toolbar\"]/android.widget.ImageButton"))
				.click();
		driver.findElement(AppiumBy.xpath("//android.widget.ImageView[@content-desc=\"logo\"]")).click();
		// driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Metal
		// cake slice\"]")).click();
...
//System.out.println(driver.getPageSource());
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText")).sendKeys("jeans");
		Thread.sleep(2000);

		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"jeans men\"]")).click();
		Thread.sleep(2000);
		driver.findElement(AppiumBy.xpath("(//android.widget.ImageView[@content-desc=\"No Data\"])[2]")).click();
